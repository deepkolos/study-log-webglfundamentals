(() => {
  // 2-二维平移，旋转，缩放和矩阵运算/WebGL 二维平移/vert.glsl
  var vert_default = "attribute vec2 a_position;\nattribute vec2 a_texcoord;\n\nvarying vec2 v_texcoord;\n\nuniform vec2 u_resolution;\nuniform vec2 u_translation;\n\nvoid main() {\n  vec2 pos = (a_position / u_resolution + u_translation) * 2.0 - 1.0;\n  pos *= vec2(1.0, -1.0);\n  gl_Position = vec4(pos, 0, 1);\n  v_texcoord = a_texcoord;\n}";

  // 2-二维平移，旋转，缩放和矩阵运算/WebGL 二维平移/frag.glsl
  ...
  // 2-二维平移，旋转，缩放和矩阵运算/WebGL 二维平移/index.ts
  var kernels = {
